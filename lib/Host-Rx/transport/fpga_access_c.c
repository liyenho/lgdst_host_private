...
#define true													1
#define false													0
#define print_usage                    puts("lgdst 0 rx [Vc]/Va/[Uc]/ns/s/wbs/ws/wb/w/rb/r/pair-id/pair-locked/loc-gps/Cst/MDst/temp/ctune/calib/calib-qry/hopless fpath/adr [bsz] [val0,val1,...], all numbers are in hex");
#define RAED_SETUP	\
