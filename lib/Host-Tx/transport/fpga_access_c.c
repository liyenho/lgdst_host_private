...
#define false													0
  ...
  #define print_usage                    puts("lgdst 0 tx bm/[Vn/Vf]/Va/fbm/[Uf/0]/ns/s/wbs/ws/wb/w/rb/r/pair-id/pair-locked/loc-gps/ant-qry/droneyaw/camyaw/Cst/MDst/temp/ctune/calib/calib-qry/hopless fpath/adr [bsz] [val0,val1,...], all numbers are in hex");
#else
  #define print_usage                    puts("lgdst 0 tx [Vn/Vf]/Va/fbm/[Uf/0]/ns/s/wbs/ws/wb/w/rb/r/pair-id/pair-locked/loc-gps/ant-qry/droneyaw/camyaw/Cst/MDst/temp/ctune/calib/calib-qry/hopless fpath/adr [bsz] [val0,val1,...], all numbers are in hex");
#endif
#define RAED_SETUP	\
...
#ifdef LIB
  int lgdst_access_tx_ctl(int argc,char **argv, void **ret)
#else
     ...
     { 	// prepend access header
			...
			strcasecmp(argv[3],"ant-qry")))
			{
        	  ...
        	  char *pc = (char*)shmLgdst_proc->access.hdr.data;
				...
				if (5 != argc ) {
					perror_exit("lgdst 0 txx bm 1/0 (1:to main, 0:upgrade)",-7);
				}
