...
// # WB filter 1 (BW = 122.09 kHz);  NB-filter 1 (BW = 122.09 kHz)
//
// Modulation index: 4
*/
...
*/
#define RF_GPIO_PIN_CFG 0x13, 0x01, 0x01, 0x20, 0x21, 0x00, 0x00, 0x00
...
*/
#define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x02, 0x00, 0x07, 0x01, 0x86, 0xA0, 0x01, 0xE8, 0x48, 0x00, 0x00, 0x02
...
*/
#define RF_MODEM_BCR_OSR_1_9 0x11, 0x20, 0x09, 0x22, 0x01, 0x90, 0x01, 0x47, 0xAE, 0x00, 0xA4, 0x02, 0xC2
...
*/
#define RF_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x04, 0x36, 0x80, 0x0E, 0x16, 0xD7, 0x80
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0x58, 0x58, 0x00, 0x02, 0xFF, 0xFF, 0x00, 0x2A
...
*/
#define RF_MODEM_OOK_CNT1_9 0x11, 0x20, 0x09, 0x42, 0xA4, 0x02, 0xD6, 0x83, 0x01, 0x0E, 0x01, 0x80, 0xFF
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x38, 0x09, 0x80, 0x00, 0x20, 0x00, 0x20, 0xFF
...
#define RADIO_CONFIGURATION_DATA { \
                            ...
                            .Radio_ConfigurationArray = RADIO_CONFIGURATION_DATA_ARRAY,                            \
                            }
...
typedef struct
{
    ...
    uint8_t	alignment_not_used;  // don't remove this line, liyenho
    uint32_t  Radio_Delay_Cnt_After_Reset;

    uint8_t   Radio_ConfigurationArray[RADIO_MAX_CONFIG_LENGTH];
} tRadioConfiguration;
