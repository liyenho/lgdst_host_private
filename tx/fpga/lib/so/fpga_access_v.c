...
#define true													1
#define false													0
#define print_usage                    puts("lgdst 0 tx [Vn/Vf]/Va/[Uf]/Ua/ns/s/wbs/ws/wb/w/rb/r//[locked]/[rfch]/[atten]/temp/ctune/ fpath/adr [chidx] [atten] [bsz] [val0,val1,...], all numbers are in hex");
#define RAED_SETUP	\
...
#ifdef LIB
  int lgdst_access_tx_vid(int argc,char **argv, void **ret)
#else
